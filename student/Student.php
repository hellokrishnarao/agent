...
class Student {
	...
	public function register($firstName, $lastName, $password, $email, $gender, $dob, $nationality, $jlpt, $phone, $api_id, $description) {
		...
		if ($count_row == 0) {
			$insert = "INSERT INTO students SET first_name='$firstName',last_name='$lastName', password='$password', email='$email', gender='$gender', dob='$dob',nationality='$nationality', jlpt = '$jlpt', phone='$phone', api_id = '$api_id', description ='$description'";
	...
	public function update_details($id, $first_name, $last_name, $jlpt, $phone, $description, $api_id) {
		...
		$update = "UPDATE `students` SET `first_name`='$first_name',`last_name`='$last_name',`jlpt`='$jlpt',`description`='$description', `api_id` = '$api_id' ,`phone`='$phone'  WHERE `id` = '$id'";
