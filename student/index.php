            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="mt-5">
                        ...
                        <h3 class="h4 mb-2">1. Select Your Teacher</h3>
                        <p class="text-muted mb-0">Select your teacher from the list and pick a slot avaiable to the teacher!</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="mt-5">
                ...
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="mt-5">
                        ...
                        <h3 class="h4 mb-2">3. Payment </h3>
                        <p class="text-muted mb-0">Pay through your credits after the session of 30 minutes is over</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="mt-5">
                        ...
                        <p class="text-muted mb-0">Share your views on the teacher!</p>
                    </div>
                </div>
            </div>
        </div>
